...
const Project = () => {
  ...
  return (
    <div className="mt-64 hidden lg:block text-black" id="projects" ref={ref}>
      <h2 className="text-3xl font-bold mb-4 text-white">Mes projets</h2>
      <div className='grid grid-cols-3 gap-x-3 gap-y-6 2xl:gap-6 2xl:grid-cols-4 items-center'>
