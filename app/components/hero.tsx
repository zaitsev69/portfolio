    ...
    return (
        <div className="bg-white w-2/3 p-6 flex items-center justify-item-center rounded-lg mx-auto mt-32">
            <div className="mr-10">
                ...
                <p className="text-lg">Développeur web passionné, basé à Lyon 👨‍💻 <br></br>Apprenti créateur d&apos;applications et site web performants et modernes.<br></br>
                ...
                <div className="flex justify-items-center justify-center space-x-4 mt-4">
                    ...
                    <a href="https://github.com/zaitsev69" target="_blank" rel="noopener noreferrer">
                        <svg className="fill-black hover:fill-neutral-400 transition-colors duration-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 30 30" width="45px" height="45px">
